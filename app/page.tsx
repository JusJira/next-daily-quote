  ...
  return (
    <main className="flex h-[100dvh] flex-col items-center justify-center p-6 md:p-24 bg-neutral-900">
      <blockquote className="font-[700] text-2xl text-white text-center text-balance text">
        {data[0].q}
        <footer className="font-[400] text-neutral-300 text-base">
          {data[0].a}
        </footer>
      </blockquote>
      <div className="bottom-1 absolute text-neutral-400 text-sm">
        Quotes API by{" "}
        <a className='text-blue-100' href="https://zenquotes.io/" target="_blank">
          ZenQuotes API
        </a>
      </div>
    </main>
